...
<div class="admin-container {$theme}">
  ...
  <div class="text-management">
    ...
    {#if showAddForm}
      <Modal
        title={editingText ? "Edit Text" : "Add New Text"}
        on:close={resetForm}
      >
        <form
          method="POST"
          action="?/{editingText ? 'updateText' : 'addText'}"
          class="text-form"
        >
          {#if editingText}
          ...
          <div class="text-card">
            <div class="text-info">
              ...
              <p class="text-meta">
                ...
                <Badge
                  type={text.difficulty.toLowerCase() as
                    | "easy"
                    | "medium"
                    | "hard"}
              ...
              {#if deleteConfirmationId === text.id}
                <div class="delete-confirmation">
                  ...
                  >
                    ...
                    <button type="button" class="cancel" on:click={cancelDelete}
                      >Cancel</button
                    >
                  </form>
                </div>
              {:else}
                <button class="delete" on:click={() => confirmDelete(text.id)}
                  >Delete</button
                >
              {/if}
            </div>
